...
public class BigPanelScreen extends GenericDMXConfigurationScreen<BigPanelBlockEntity> {
    private BasicSlider tiltSlider, panSlider;
    private final BigPanelBlockEntity be;

    public BigPanelScreen(BigPanelBlockEntity be) {
        super(be, be.getBlockPos(), "block.theatrical.big_panel");
        this.be = be;
    }
