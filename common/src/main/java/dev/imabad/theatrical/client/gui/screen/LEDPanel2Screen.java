...
public class LEDPanel2Screen extends GenericDMXConfigurationScreen<LEDPanel2BlockEntity> {
    private BasicSlider tiltSlider, panSlider;
    private final LEDPanel2BlockEntity be;

    public LEDPanel2Screen(LEDPanel2BlockEntity be) {
        super(be, be.getBlockPos(), "block.theatrical.led_panel_2");
        this.be = be;
    }
