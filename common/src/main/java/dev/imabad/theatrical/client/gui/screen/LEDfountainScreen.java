...
public class LEDfountainScreen extends GenericDMXConfigurationScreen<LEDfountainBlockEntity> {
    private BasicSlider tiltSlider, panSlider;
    private final LEDfountainBlockEntity be;

    public LEDfountainScreen(LEDfountainBlockEntity be) {
        super(be, be.getBlockPos(), "block.theatrical.led_fountain");
        this.be = be;
    }
