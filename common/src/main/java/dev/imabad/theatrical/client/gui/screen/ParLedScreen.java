...
public class ParLedScreen extends GenericDMXConfigurationScreen<ParLedBlockEntity> {
    private BasicSlider tiltSlider, panSlider;
    private final ParLedBlockEntity be;

    public ParLedScreen(ParLedBlockEntity be) {
        super(be, be.getBlockPos(), "block.theatrical.par_led");
        this.be = be;
    }
