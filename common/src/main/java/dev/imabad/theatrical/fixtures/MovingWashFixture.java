...
public class MovingWashFixture extends Fixture {
    ...
    private static final Identifier TILT_MODEL = Theatrical.location( "block/moving_wash/moving_wash_tilt");
    private static final Identifier PAN_MODEL = Theatrical.location( "block/moving_wash/moving_wash_pan");
    private static final Identifier STATIC_MODEL = Theatrical.location( "block/moving_wash/moving_wash_static");
